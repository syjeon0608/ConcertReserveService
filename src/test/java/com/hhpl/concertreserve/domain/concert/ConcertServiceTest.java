...
class ConcertServiceTest {
    ...
    public void testGetAvailableSeats() {
        ...
        List<Seat> mockSeats = Arrays.asList(
                new Seat(1L, 1, mockSchedule, 50000, SeatStatus.AVAILABLE, LocalDateTime.now(), LocalDateTime.now().plusHours(1)),
                new Seat(2L, 2, mockSchedule, 50000, SeatStatus.AVAILABLE, LocalDateTime.now(), LocalDateTime.now().plusHours(1)),
                new Seat(3L, 3, mockSchedule, 50000, SeatStatus.UNAVAILABLE, LocalDateTime.now(), LocalDateTime.now().plusHours(1))
        );
