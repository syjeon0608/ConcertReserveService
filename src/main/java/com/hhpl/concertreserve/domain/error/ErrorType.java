...
public enum ErrorType {
    ...
    UUID_VALIDATION_FAILED(ErrorCode.AUTHORIZATION_ERROR, "UUID가 검증에 실패하였습니다.", LogLevel.INFO),
    CONCERT_ID_VALIDATION_FAILED(ErrorCode.AUTHORIZATION_ERROR, "콘서트 ID가 검증에 실패하였습니다.", LogLevel.INFO),
